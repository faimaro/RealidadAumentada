...
#include "../EP_DelimitacionBoca/imagen.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Imagen_t, stringdata) + ofs \
...
const QMetaObject Imagen::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Imagen.data,
      qt_meta_data_Imagen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Imagen.stringdata))
